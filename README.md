# traffic-ai
I wrote an AI to identify which traffic sign appears in a photograph, using **TensorFlow**, and built a neural network to classify road signs based on an image of those signs. 
